...
![The Create new TwiML App dialog in the Twilio Console](./docs/images/create-new-twiml-app/set-the-friendly-name.png)

3. In the **Create new TwiML App** dialog that appears, add a **Friendly name** for the app, such as "Answer a Call", and click **Create**
4. In the **Primary call control configuration** section of the **VOICE** tab, set your ngrok Forwarding URL as the value of the **Request URL** field, and leave the accompanying **HTTP method** field set to "HTTP POST"

![The voice configuration details of a TwiML app in the Twilio Console](./docs/images/create-new-twiml-app/set-the-voice-configuration.png)

5. Then, click the **MESSAGING** tab.
   There, set your ngrok Forwarding URL plus "/support" as the value of the **Request URL** field, and leave the accompanying **HTTP method** field set to "HTTP POST"

![The messaging configuration details of a TwiML app in the Twilio Console](./docs/images/create-new-twiml-app/set-the-messaging-configuration.png)
